...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=34';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=34';
import { contactsComputed, contactsMethods }    from './contacts.js?v=34';
import { planningComputed, planningMethods }    from './planning.js?v=34';
import { adminMethods }                           from './modules/adminMethods.js?v=34';
import { mapMethods }                             from './modules/mapMethods.js?v=34';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=34';
import { importMethods }                         from './modules/importMethods.js?v=34';
import { gouvMethods }                           from './modules/gouvMethods.js?v=34';
import { searchMethods }                         from './modules/searchMethods.js?v=34';
import { projectMethods }                        from './modules/projectMethods.js?v=34';
import { venueMethods }                          from './modules/venueMethods.js?v=34';
import { crmMethods }                            from './modules/crmMethods.js?v=34';
import { appComputed }                           from './modules/appComputed.js?v=34';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=34';
import { icalMethods }                            from './modules/icalMethods.js?v=34';
import { updateMethods }                          from './modules/updateMethods.js?v=34';
