...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=25';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=25';
import { contactsComputed, contactsMethods }    from './contacts.js?v=25';
import { planningComputed, planningMethods }    from './planning.js?v=25';
import { adminMethods }                           from './modules/adminMethods.js?v=25';
import { mapMethods }                             from './modules/mapMethods.js?v=25';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=25';
import { importMethods }                         from './modules/importMethods.js?v=25';
import { gouvMethods }                           from './modules/gouvMethods.js?v=25';
import { searchMethods }                         from './modules/searchMethods.js?v=25';
import { projectMethods }                        from './modules/projectMethods.js?v=25';
import { venueMethods }                          from './modules/venueMethods.js?v=25';
import { crmMethods }                            from './modules/crmMethods.js?v=25';
import { appComputed }                           from './modules/appComputed.js?v=25';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=25';
import { icalMethods }                            from './modules/icalMethods.js?v=25';
import { updateMethods }                          from './modules/updateMethods.js?v=25';
