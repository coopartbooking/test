...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=28';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=28';
import { contactsComputed, contactsMethods }    from './contacts.js?v=28';
import { planningComputed, planningMethods }    from './planning.js?v=28';
import { adminMethods }                           from './modules/adminMethods.js?v=28';
import { mapMethods }                             from './modules/mapMethods.js?v=28';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=28';
import { importMethods }                         from './modules/importMethods.js?v=28';
import { gouvMethods }                           from './modules/gouvMethods.js?v=28';
import { searchMethods }                         from './modules/searchMethods.js?v=28';
import { projectMethods }                        from './modules/projectMethods.js?v=28';
import { venueMethods }                          from './modules/venueMethods.js?v=28';
import { crmMethods }                            from './modules/crmMethods.js?v=28';
import { appComputed }                           from './modules/appComputed.js?v=28';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=28';
import { icalMethods }                            from './modules/icalMethods.js?v=28';
import { updateMethods }                          from './modules/updateMethods.js?v=28';
