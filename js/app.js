...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=24';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=24';
import { contactsComputed, contactsMethods }    from './contacts.js?v=24';
import { planningComputed, planningMethods }    from './planning.js?v=24';
import { adminMethods }                           from './modules/adminMethods.js?v=24';
import { mapMethods }                             from './modules/mapMethods.js?v=24';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=24';
import { importMethods }                         from './modules/importMethods.js?v=24';
import { gouvMethods }                           from './modules/gouvMethods.js?v=24';
import { searchMethods }                         from './modules/searchMethods.js?v=24';
import { projectMethods }                        from './modules/projectMethods.js?v=24';
import { venueMethods }                          from './modules/venueMethods.js?v=24';
import { crmMethods }                            from './modules/crmMethods.js?v=24';
import { appComputed }                           from './modules/appComputed.js?v=24';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=24';
import { icalMethods }                            from './modules/icalMethods.js?v=24';
import { updateMethods }                          from './modules/updateMethods.js?v=24';
