...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=23';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=23';
import { contactsComputed, contactsMethods }    from './contacts.js?v=23';
import { planningComputed, planningMethods }    from './planning.js?v=23';
import { adminMethods }                           from './modules/adminMethods.js?v=23';
import { mapMethods }                             from './modules/mapMethods.js?v=23';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=23';
import { importMethods }                         from './modules/importMethods.js?v=23';
import { gouvMethods }                           from './modules/gouvMethods.js?v=23';
import { searchMethods }                         from './modules/searchMethods.js?v=23';
import { projectMethods }                        from './modules/projectMethods.js?v=23';
import { venueMethods }                          from './modules/venueMethods.js?v=23';
import { crmMethods }                            from './modules/crmMethods.js?v=23';
import { appComputed }                           from './modules/appComputed.js?v=23';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=23';
import { icalMethods }                            from './modules/icalMethods.js?v=23';
import { updateMethods }                          from './modules/updateMethods.js?v=23';
