...
// --- IMPORTS FIREBASE ---
import { auth, dbFirestore }                                              from './firebase.js?v=35';
...
// --- IMPORTS MODULES ---
import { utilsMethods }                         from './utils.js?v=35';
import { contactsComputed, contactsMethods }    from './contacts.js?v=35';
import { planningComputed, planningMethods }    from './planning.js?v=35';
import { adminMethods }                           from './modules/adminMethods.js?v=35';
import { mapMethods }                             from './modules/mapMethods.js?v=35';
import { annuaireMethods }                       from './modules/annuaireMethods.js?v=35';
import { importMethods }                         from './modules/importMethods.js?v=35';
import { gouvMethods }                           from './modules/gouvMethods.js?v=35';
import { searchMethods }                         from './modules/searchMethods.js?v=35';
import { projectMethods }                        from './modules/projectMethods.js?v=35';
import { venueMethods }                          from './modules/venueMethods.js?v=35';
import { crmMethods }                            from './modules/crmMethods.js?v=35';
import { appComputed }                           from './modules/appComputed.js?v=35';
import { collaboratorMethods }                   from './modules/collaboratorMethods.js?v=35';
import { icalMethods }                            from './modules/icalMethods.js?v=35';
import { updateMethods }                          from './modules/updateMethods.js?v=35';
